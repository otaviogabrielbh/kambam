...
import { Assignee, ChecklistTemplate, ASSIGNEE_COLORS } from '../types';
import {
  X,
  Users,
  ListChecks,
...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const [tab, setTab] = useState<'members' | 'checklists'>('members');
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Cadastro de responsáveis e checklists de tarefas
              </p>
            </div>
          </div>
